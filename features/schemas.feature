...
#    And I should see "We did not expect to see the column <code>URL</code>, given the schema you used."
    ...
    And I should see "Values in the <code>Age</code> column must be between 13 and 99 inclusive. <code>4</code> is too low."
    And I should see "Values in the <code>Age</code> column must be between 13 and 99 inclusive. <code>103</code> is too high."
    And I should see "Values in the <code>Height</code> column must be 20 or higher. <code>13</code> is too low."